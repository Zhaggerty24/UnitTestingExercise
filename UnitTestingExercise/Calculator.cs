...
namespace UnitTestingExercise
{
    public class Calculator
    {
        ...
        public int Add(int myNum1, int myNum2, int myNum3)
        {
            return myNum1 + myNum2 + myNum3;
        }
        ...
        public int Subtract(int myNum1, int myNum2)
        {
        ...
        public int Multiply(int myNum1, int myNum2)
        {
            return myNum1 * myNum2;
        }
        ...
        public int Divide(int myNum1, int myNum2)
        {
            return myNum1 / myNum2;
        }
